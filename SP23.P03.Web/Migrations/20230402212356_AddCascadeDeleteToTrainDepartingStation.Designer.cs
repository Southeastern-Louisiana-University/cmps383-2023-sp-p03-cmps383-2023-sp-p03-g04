...
namespace SP23.P03.Web.Migrations
{
    ...
    [Migration("20230402212356_AddCascadeDeleteToTrainDepartingStation")]
    partial class AddCascadeDeleteToTrainDepartingStation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SP23.P03.Web.Features.Address.TrainStationAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SP23.P03.Web.Features.Carriers.Carrier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SP23.P03.Web.Features.Trains.TrainCar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SP23.P03.Web.Features.Trains.TrainCarType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SP23.P03.Web.Features.Address.TrainStationAddress", b =>
                {
                    b.HasOne("SP23.P03.Web.Features.TrainStations.TrainStation", null)
                        .WithOne("TrainStationAddress")
                        .HasForeignKey("SP23.P03.Web.Features.Address.TrainStationAddress", "TrainStationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SP23.P03.Web.Features.Trains.TrainCar", b =>
                {
                    b.HasOne("SP23.P03.Web.Features.Trains.TrainCarType", "TrainCarType")
                        .WithMany()
                        .HasForeignKey("TrainCarTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SP23.P03.Web.Features.TrainStations.TrainStation", b =>
                {
                    b.Navigation("TrainStationAddress")
                        .IsRequired();
                });
